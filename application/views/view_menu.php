                    ...
                    success : function(response){
                        ...
                        if(res.message = 'success'){
                            ...
                            if(res.data.length > 0){
                                ...
                                $("#QRCode2").html('<div class="col-lg-12"><img src="'+base_url+'assets/images/QRCodeOrder/'+res.QRCode2+'"></div>');
                    ...
                    success : function(response){
                        ...
                        if(res.message = 'success'){
                            if(res.data.length > 0){
                                ...
                                $("#QRCode1").html('<div class="col-lg-12"><img src="'+base_url+'assets/images/QRCodeOrder/'+res.QRCode1+'"></div>');
